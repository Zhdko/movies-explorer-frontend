    ...
    <section className='portfolio'>
      ...
      <ul className='list portfolio__list'>
        <li className='portfolio__item'>
          <a href='https://github.com/Zhdko/how-to-learn' className='portfolio__link link'>
        ...
        <li className='portfolio__item'>
          <a href='https://zhdko.github.io/Web_3.0/' className='portfolio__link link'>
        ...
        <li className='portfolio__item'>
          <a href='https://github.com/Zhdko/react-mesto-api-full-gha' className='portfolio__link link'>
